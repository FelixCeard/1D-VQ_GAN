...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project="[NNTI]Spectroformer")

    # load configs
    print('loading configs')
    configs = [OmegaConf.load('configs/[TRAIN]SpectogramTransformerSingleSpeakerWithDataAugment.yaml')]
